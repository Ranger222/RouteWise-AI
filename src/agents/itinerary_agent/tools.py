...
class ItineraryTools:
    ...
    def synthesize(self, query: str, insights: List[Insight]) -> Itinerary:
        ...
        prompt = (
            ...
            "Include: a one-paragraph summary, day-by-day schedule with times, transport options with booking links/systems, budget line items, neighborhoods to target/avoid with 2 sample budget accommodations (name, ~price, link), a food & local experiences section, transport safety notes, and a checklist. "
